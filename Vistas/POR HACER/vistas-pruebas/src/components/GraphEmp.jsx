  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="dashboard-header">
        <h1 className="dashboard-title">Resumen de la Empresa</h1>
        <p className="dashboard-subtitle">Monitorea el estado general de tus reclutadores en Caspita</p>
      </div>
      ...
      <div className="dashboard-grid">
        ...
        {/*Reclutadores*/}
        <div>
          <h2 className="section-title">Reclutadores Activos</h2>
          <div className="chart-card">
            ...
            <GraficoBarras 
              ...
              ejeXClave="mes"
              barras={[
                { clave: 'totales', nombre: 'Empresas Registradas', color: '#132f70' },
                { clave: 'reportadas', nombre: 'Empresas con Reportes', color: '#df3064' }
              ]}
            />
          </div>
        </div>
          ...
          <div className="chart-card">
            ...
            <GraficoBarras 
              ...
              barras={[
                ...
                { clave: 'conReporte', nombre: 'Vacantes con Reportes', color: '#df3064' }
              ]}
            />
          </div>
        </div>
