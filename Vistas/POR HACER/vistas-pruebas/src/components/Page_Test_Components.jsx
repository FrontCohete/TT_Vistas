...
const ModalCorreccion = ({ empresa, alCerrar, onEnviar }) => {
  ...
  return (
    <>
      ...
      {/* INYECCIÓN DE CSS RESPONSIVO Y ANIMACIONES */}
      <style>{`
        ...
        @media (max-width: 768px) {
          .grid-campos {
            ...
            gap: 16px; /* Reducimos un poco el espacio para optimizar pantalla */
          }
          
          /* Ajustes adicionales para que se vea mejor en pantallas pequeñas */
          .btn-modal {
...
const styles = {
  ...
  // Reducimos un poco la fuente del título para evitar desbordes en móviles muy estrechos
  ...
  // Agregamos la clase footer-responsivo al div para manipularlo en CSS
