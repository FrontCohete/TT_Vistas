...
const items = [
  ...
  { name: " Vacantes", path: "/vacantes", icon: "fi fi-rr-briefcase"},
  { name: " Perfil", path: "/perfil", icon: "fi fi-rr-graduation-cap"},
];
  ...
  return (
    <>
      <nav className="page navbar">
        <section ref={navContainerRef} className={`navbar-container ${isVisible ? "" : "navbar-hidden"}`}>
      ...
      {/* Le pasamos la altura exacta (navHeight) calculada por React */}
      <CSSTransition
        in={location.pathname === "/vacantes"}
        nodeRef={searchRef}
        timeout={300}
